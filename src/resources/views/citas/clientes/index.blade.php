<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('citasclientes.create') }}" class="btn btn-outline-primary px-2 py-1 rounded-md">
                {{ __('Nueva cita') }}
            </a>
        </div>
    </x-slot>
                        ...
                        <table class="table-fixed w-full border-collapse border border-gray-300">
                            <thead>
                                <tr class="bg-gray-100">
                                    ...
                                    <th class="border border-gray-300 px-4 py-2 w-1/6">{{ __('Matrícula') }}</th>
                                    <th class="border border-gray-300 px-4 py-2 w-1/6">{{ __('Fecha') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border border-gray-300 px-4 py-2 w-1/6 text-center">
                                            <div class="flex justify-center items-center gap-1">
                                                <a href="{{ route('citasclientes.show', $cita) }}" class="btn btn-sm btn-outline-primary" title="{{ __('Ver') }}">
